...
export const siteCopy = {
  ...
  nav: {
    ...
    matrix500: h("500-Page Matrix", { context: "label" }),
  ...
  benchmark: {
    ...
    matrixExplorer: {
      ...
      roleShortcutsTitle: h("Top role shortcuts", { context: "headline" }),
      countryShortcutsTitle: h("Top country shortcuts", { context: "headline" }),
      categoryLabel: h("Category", { context: "label" }),
      allCategories: h("All categories", { context: "label" }),
      sortLabel: h("Sort", { context: "label" }),
  ...
  internalDocs: {
    ...
    interlinkTitle: h("Interlinked Routes", { context: "headline" }),
    relatedDocsTitle: h("Related Research Records", { context: "headline" }),
    benchmarkRoutesTitle: h("Related Benchmark Routes", { context: "headline" }),
    sectionMetaTitle: h("Section 1: Source Metadata", { context: "headline" }),
    sectionSummaryTitle: h("Section 2: Executive Summary", { context: "headline" }),
    sectionFindingsTitle: h("Section 3: Findings and Claims", { context: "headline" }),
    sectionRelevanceTitle: h("Section 4: Methodology Relevance", { context: "headline" }),
    sectionEvidenceTitle: h("Section 5: Extracted Evidence Snippets", { context: "headline" }),
